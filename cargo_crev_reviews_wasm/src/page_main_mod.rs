...
fn button_save_review_on_click(_element_id: &str) {
    ...
    let thoroughness = w::get_input_element_value_string_by_id("thoroughness");
    let understanding = w::get_input_element_value_string_by_id("understanding");
    let rating = w::get_input_element_value_string_by_id("rating");
    let comment_md = w::get_input_element_value_string_by_id("review_md");
    ...
    let json_string = unwrap!(serde_json::to_string_pretty(&rpc));
